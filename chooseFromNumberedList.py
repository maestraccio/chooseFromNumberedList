            ...
            if Accept == 1:
                ...
                if ip in HiddenList:
                    ...
                    if WaitForEnter == True:
                        WaitForEnter = False
                    elif Int in range(StartWithZeroOrOne,StartWithZeroOrOne+len(NumberedList)):
                        if Int not in MCList:
                            MCList.append(Int)
...
#what, where = chooseFromNumberedList([TestList,"A",1,1,"O",TestHiddenList,1,False])
#print(what, where)
